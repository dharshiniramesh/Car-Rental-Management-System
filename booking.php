...
<label for="cars">Choose the City:</label>

<select id="cities">
  <option value="volvo">Chennai</option>
  <option value="saab">Coimbatore</option>
  <option value="opel">Erode</option>
  <option value="audi">Madurai</option>
<option value="audi">Trichy</option>
<option value="audi">Salem</option>
<option value="audi">Vellore</option>
<option value="audi">Dindigul</option>
<option value="audi">Tiruppur</option>
<option value="audi">Tirunelveli</option>
<option value="audi">Karur</option>
<option value="audi">Tanjore</option>
<option value="audi">Krishnagiri</option>
<option value="audi">Kanyakumari</option>
<option value="audi">Virudhunagar</option>
</select><br><br>
</label>
...
<label for="fname">Pickup Location:</label>
  <input type="text" id="plocation" name="plocation"><br><br>
  <label for="lname">Dropoff Location:</label>
  <input type="text" id="dlocation" name="dlocation"><br><br>
</label>
